...
<div class="body-content" style="padding-top:60px !important;">
	<div class="map">
        <div id="map"></div>
   </div>
</div>
...
function initMap() {
  map = new google.maps.Map(document.getElementById('map'), {
    zoom: 14,
    center: {lat: <?php echo $myLocation[0]->latitude; ?>, lng: <?php echo $myLocation[0]->longitude; ?>},
    mapTypeId: 'satellite'
  });
...
<script async defer
src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDeoMFl4_cvsUW8AEJJEjfuBAG-PHdCaeo&libraries=visualization&callback=initMap">>
</script>
