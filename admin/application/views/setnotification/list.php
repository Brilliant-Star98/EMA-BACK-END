                    ...
                    <div class="card-body table-responsive">
                        <div class="">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo ($Notification->fname != NULL ? $Notification->fname." ".$Notification->lname : "Sent to All Users"); ?></td>
                                    <td><?php echo $Notification->n_title; ?> </td>
                                    <td><?php echo $Notification->title; ?> </td>
                                    <td><?php echo $Notification->message; ?> </td>
                                    <td>
                                        <a class=" btn btn-sm btn-dark" style="float: none; padding:5px; margin: 0px;" href="<?=base_url();?>edit-notification-set?id=<?=$Notification->id; ?>"><span class="ti-pencil"></span></a>
...
function deleteRow(orderid) {
			 ...
			 $.ajax({
					url: '<?=base_url();?>delete-notification-set?id='+orderid,
					type: 'POST',
					data: 'delete='+orderid,
					dataType: 'json'
			 })
