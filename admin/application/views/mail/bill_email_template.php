                ...
                <td colspan="2" style="padding: 5px; vertical-align: top;">
                    <table style="width: 100%;line-height: inherit;text-align: left;max-width: 800px;">
                        <tr>
							...
							<h1><?= $billDetails[0]->bill_title ?> Bill</h1>
                            </td>

                            <td style="text-align:right; padding: 5px; vertical-align: top;">
                                Bill No. #: EMA00<?= $billDetails[0]->id ?><br>
                                Created : <?= date("F j, Y", strtotime($billDetails[0]->bill_generated_date)) ?><br>
                                Due : <?= date("F j, Y", strtotime($billDetails[0]->due_date)) ?>
                            </td>
