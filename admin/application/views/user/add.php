        ...
        <div class="row">
		 ...
		 <div class="row">
				 <div class="col-md-12">
                      ...
                      <form class="" method="post" action="<?=base_url('add-user'); ?>" enctype="multipart/form-data">
                           <div class="row">
                            ...
                            <div class="row">
															...
															<?php foreach ($BillType as $Bill): ?>
																	<input type="checkbox" name="billtype[]" value="<?= $Bill->id; ?>"> <?= $Bill->bill_title; ?>
															<?php endforeach; ?>
															 </div>
															</div>
													 </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div>
                                        <input parsley-type="number" name="house_number" type="text" value="<?php echo set_value('house_number'); ?>" class="form-control" required placeholder="House Number"/>
                                    </div>
                                </div>
                            </div>
