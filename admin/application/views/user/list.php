                ...
                <div class="card m-b-30">
                    <div class="card-body table-responsive">
                        <div class="">
                                ...
                                <tbody>
																	<?php foreach ($AddUserData as $agent) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <!-- <a class="sb-toggle-right btn btn-sm btn-info" onclick="setvaluemodel(<?=$agent->userId; ?>)" style="float: none; padding:5px; margin: 0px;"><span class="mdi mdi-eye"></span></a> -->
