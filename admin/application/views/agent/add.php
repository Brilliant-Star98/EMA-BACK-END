        ...
        <div class="row">
		 ...
		 <div class="row">
				 <div class="col-md-12">
                        ...
                        <form class="" method="post" action="<?=base_url('add-agent'); ?>" enctype="multipart/form-data">
                           <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col">
                                    ...
                                    <div>
                                        <input type="email" name="contact_email" class="form-control" value="<?php echo set_value('contact_email'); ?>" required parsley-type="email" placeholder="Enter e-mail"/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="form-group col">
                                    ...
                                    <div>
                                        <input parsley-type="text" name="alt_mobile" type="text" value="<?php echo set_value('alt_mobile'); ?>" class="form-control" required placeholder="Alternate Mobile Number"/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="form-group col">
                                    ...
                                    <div>
                                        <textarea required class="form-control" name="content" rows="5"><?php echo set_value('content'); ?></textarea>
                                    </div>
                                </div>
...
$('#us2').locationpicker({
    location: {
			latitude:<?php if(set_value('latitude')){ echo set_value('latitude');}else{ echo "46.15242437752303"; } ?>,
			longitude:<?php if(set_value('longitude')){ echo set_value('longitude');}else{ echo "2.7470703125";  } ?>
