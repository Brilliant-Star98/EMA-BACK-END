...
<div class="body-content">
	<div class="container-fluid">
    	<div class="page-head">
            <h4 class="mt-2 mb-2">BillType List</h4>
        </div>
        <div class="row">
                ...
                <div class="card m-b-30">
                    <div class="card-body table-responsive">
                        <div class="">
                                ...
                                <tbody>
																	<?php foreach ($BillTypeData as $BillType) { ?>
                                <tr>
                                    <td><?php echo $BillType->bill_title; ?> </td>
                                    <td><?php echo $BillType->bill_description; ?> </td>
                                    <td><img src="<?=base_url('assets/uploads/');?><?=$BillType->bill_logo; ?>" alt="" width="200"></td>
                                    <td><?=$BillType->ismanual == '0' ? "Manual" : "Fixed" ?></td>
                                    <td>
                                        <a class=" btn btn-sm btn-dark" style="float: none; padding:5px; margin: 0px;" href="<?=base_url();?>edit-billtype?id=<?=$BillType->id; ?>"><span class="ti-pencil"></span></a>
                                        <a class="btn btn-danger btn-animation"  onclick="deleteRow(<?=$BillType->id; ?>)"  style="float: none; padding:5px; margin: 0px;">
...
function deleteRow(orderid) {
			 ...
			 $.ajax({
					url: '<?=base_url();?>delete-billtype?id='+orderid,
					type: 'POST',
					data: 'delete='+orderid,
					dataType: 'json'
			 })
