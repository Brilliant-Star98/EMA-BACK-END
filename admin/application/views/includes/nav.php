<div class="header-section">
                    ...
                    <div id="navbar-collapse-1" class="navbar-collapse collapse mega-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <form class="search-content" action="http://preview.freewebtemplatesdownload.com/syntra/index.html" method="post">
                    ...
                    <div class="notification-wrap">
                        <div class="right-notification">
							...
							<!--
                                ...
                                <li>
                                    <a href="javascript:;" data-toggle="dropdown" class="mt-3">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right profile-menu">
                                        ...
                                        <a class="dropdown-item" href="<?php echo base_url('loadChangePass');?>"><i class="mdi mdi-settings m-r-5 text-muted"></i> Change Password</a>
